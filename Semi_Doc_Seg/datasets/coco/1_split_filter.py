...
dataDir = '/data2/users/abanerjee/HJDataset/annotations'
support_dict = {}
...
voc_inds = (0, 1, 2, 3, 4, 5, 7)


for dataType in ['instances_train.json']: #, 'split_voc_instances_train2017.json']:
    ...
    split2_file = os.path.join(root_path, 'new_annotations/final_split_non_voc_instances_train20171.json')
